...
int game_loop(SDL_Renderer *rend)
{
    ...
    sandMap.register_tile("blank", 0, 0);
    sandMap.register_tile("wall", 56, 0);
    sandMap.register_tile("roofHori", 112, 0);
    sandMap.register_tile("roofHoriLeft", 168, 0);
    sandMap.register_tile("roofHoriRight", 224, 0);
    sandMap.register_tile("roofCornerLeftT", 0, 56);
    sandMap.register_tile("roofCornerRightT", 56, 56);
    sandMap.register_tile("roofVert", 112, 56);
    sandMap.register_tile("roofVertBottom", 168, 56);
    sandMap.register_tile("roofCornerLeftB", 224, 56);
    sandMap.register_tile("roofCornerRightB", 0, 112);
    sandMap.register_tile("roofVertTop", 56, 112);
    sandMap.register_tile("roofPillar", 112, 112);
    sandMap.register_tile("floor", 168, 112);
    sandMap.register_tile("dungeonWall", 224, 112);
    sandMap.register_tile("topRoofT", 56, 168);
    sandMap.register_tile("leftRoofT", 112, 168);
    sandMap.register_tile("bottomRoofT", 168, 168);
    sandMap.register_tile("rightRoofT", 224, 168);
